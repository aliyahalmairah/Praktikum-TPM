...
import 'package:news_app/user/logout_page.dart';
...
class _HomeState extends State<Home> {
  ...
  Future _getData() async {
    try {
      final response = await http.get(Uri.parse('https://newsapi.org/v2/top-headlines?country=id&apiKey=742bc800bad74fcba0a2bed19ce9bd30'));
